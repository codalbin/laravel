...
<nav class="bg-gray-300" x-data="{ isOpen: false }">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <a href="/blog" class="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-700 hover:text-white">Blog</a>
            <a href="/contacts" class="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-700 hover:text-white">Contacts</a>
            </div>
        </div>   
        </div>
        <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
            ...
            <div>
                ...
                <img class="h-8 w-8 rounded-full" src="{{ asset('img/profil_picture.jpg') }}" alt="">
                </button>
            </div>
    ...
    <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-full" src="{{ asset('img/profil_picture.jpg') }}" alt="">
        </div>
        <!-- <div class="ml-3">
